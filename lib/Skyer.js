...
Skyer.Route           = require('./AbstractRoute');
Skyer.Service         = require('./AbstractService');
Skyer.Controller      = require('./AbstractController');
Skyer.AppMiddleware   = require('./AppMiddleware');
Skyer.RouteMiddleware = require('./RouteMiddleware');
